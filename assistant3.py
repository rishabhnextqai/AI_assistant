...
def generate_podcast_script(file_contents: str, podcast) -> str:
    if podcast == 'exec':
        prompt = f"""
Create a dynamic and engaging podcast script for "Next Quarter's Executive Briefing" featuring two hosts, Zoe and Ethan. The podcast should focus on strategic priorities and key initiatives for a specific account, using the provided content as the foundation:
...
1. **Introduction**:
   ...
   - Let Ethan take the lead in setting the tone and starting the introduction.
...
2. **Best 4 Initiatives**:
   ...
   - Alternate between Ethan and Zoe for presenting each initiative to create a natural flow.
...
3. **Other Sections**:
   ...
   - Alternate between Ethan and Zoe for presenting these sections.
...
"""
    ...
    if podcast == 'businessoverview':
        prompt = f"""
Continue the "Next Quarter's Executive Briefing" podcast featuring hosts Zoe and Ethan. In this segment, focus on the Business Overview and SWOT analysis based on the provided content:
...
1. **Transition**:
   - Begin with a smooth transition from the previous segment about initiatives, led by Ethan to vary the flow.
...
2. **SWOT Analysis**:
   ...
   - Let Zoe present the strength and Ethan follow with the weakness for a natural conversational flow.
...
3. **Roadmap Commentary**:
   ...
   - Assign this section to Ethan for consistency in delivery.
...
4. **Market Trend**:
   ...
   - Let Zoe take the lead in presenting this section.
...
5. **Industry Trend**:
   ...
   - Assign this section to Ethan to balance roles.
...
6. **Tone and Storytelling**:
   ...
   - Maintain an upbeat tone with Ethan leading transitions in this segment while Zoe provides complementary insights and reactions.
   - Avoid overly long pauses or forced transitions like "oh great" or "absolutely." Focus on smooth, natural phrasing.

7. **Conclusion**:
   - Summarize key points discussed in this segment concisely, alternating between Zoe and Ethan for final thoughts.
...
9. **Dialogue Style**:
   - Use alternating dialogue format between Zoe and Ethan as follows:
     - Ethan: [Ethan's dialogue]
     - Zoe: [Zoe's dialogue]
...
"""
    ...
    if podcast == 'competitors':
        prompt = f"""
Continue the "Next Quarter's Executive Briefing" podcast featuring hosts Zoe and Ethan. In this segment, shift the focus to Competitors based on the provided content:
...
1. **Transition**:
   - Begin with a smooth transition from the Business Overview segment, led by Ethan to vary the flow.
...
2. **Competitor Analysis**:
   ...
   - Let Ethan present this section for consistency in delivery.
...
3. **Client Gaps**:
   ...
   - Assign this section to Zoe to balance roles.
...
4. **Detailed Competitor Spotlight**:
   ...
   - Let Ethan take the lead in presenting this section.
...
5. **Countermeasures**:
   ...
   - Assign this section to Zoe to provide a natural flow between hosts.

6. **Tone and Engagement**:
   - Maintain an engaging and conversational tone throughout, with Ethan leading transitions in this segment while Zoe provides complementary insights and reactions.
   - Avoid overly long pauses or forced transitions like "oh great" or "absolutely." Focus on smooth, natural phrasing.
...
"""
    ...
    if podcast == 'stakeholders':
        prompt = f"""
Conclude the "Next Quarter's Executive Briefing" podcast featuring hosts Zoe and Ethan by focusing on Key Stakeholders based on the provided content:
...
1. **Transition**:
   - Begin with a seamless and engaging transition from the previous segment about Competitors, led by Ethan to vary the flow.
...
2. **Stakeholder Identification**:
   ...
   - Let Ethan present this section for consistency.
...
5. **Relationship Strategies**:
   ...
   - Assign this section to Zoe for a natural flow between hosts.

6. **Tone and Storytelling**:
   - Incorporate relevant sales and marketing buzzwords naturally into the conversation while maintaining an upbeat tone, led primarily by Ethan in this segment while Zoe provides complementary insights and reactions.
...
7. **Conclusion of Segment**:
   ...
   - Alternate between Ethan and Zoe for final thoughts.

8. **Podcast Closing**:
   - End with a reflective closing statement from both Ethan and Zoe:
...
10. **Dialogue Style**:
    - Use alternating dialogue format between Ethan and Zoe as follows:
      - Ethan: [Ethan's dialogue]
      - Zoe: [Zoe's dialogue]
      - Continue this pattern throughout the script, with one host leading each section for smoother transitions.
    - Avoid naming the hosts within their dialogue; focus on conversational phrasing instead.
